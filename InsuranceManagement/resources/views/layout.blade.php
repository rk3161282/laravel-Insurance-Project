...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ URL::asset('assets/libs/jquery-datetimepicker/2.5.4/jquery.datetimepicker.min.css') }}" rel="stylesheet" type="text/css" />
        <!-- color picker css -->
        ...
        <link href="http://143.110.180.160/DGMudra/public/assets/plugins/select2/css/select2.min.css" rel="stylesheet" />
	    <link href="http://143.110.180.160/DGMudra/public/assets/plugins/select2/css/select2-bootstrap4.css" rel="stylesheet" />
        <style>
            .error{color:red;}
            li.active {
                color: #fff;
    ...
    <!-- <body data-layout="horizontal"> -->
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{route('dashboard')}}" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="24"> <span class="logo-txt">Insurance</span>
                                </span>
                            </a>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    ...
                                    <span data-key="t-icons">LMS</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="icons-boxicons.html" data-key="t-boxicons">New Lead</a></li>
                                    <li><a href="icons-materialdesign.html" data-key="t-material-design">Exiting Lead</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('auth-login')}}" data-key="t-login">Login</a></li>
                                    <li><a href="{{route('auth-register')}}" data-key="t-register">Register</a></li>
                                    <li><a href="{{route('auth-recoverpw')}}" data-key="t-recover-password">Recover Password</a></li>
                                    <li><a href="{{route('auth-lock-screen')}}" data-key="t-lock-screen">Lock Screen</a></li>
                                    <li><a href="{{route('auth-logout')}}" data-key="t-logout">Log Out</a></li>
                                    <li><a href="{{route('auth-confirm-mail')}}" data-key="t-confirm-mail">Confirm Mail</a></li>
                                    <li><a href="{{route('auth-email-verification')}}" data-key="t-email-verification">Email Verification</a></li>
                                    <li><a href="{{route('auth-two-step-verification')}}" data-key="t-two-step-verification">Two Step Verification</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('pages-starter')}}" data-key="t-starter-page">Starter Page</a></li>
                                    <li><a href="{{route('pages-maintenance')}}" data-key="t-maintenance">Maintenance</a></li>
                                    <li><a href="{{route('pages-comingsoon')}}" data-key="t-coming-soon">Coming Soon</a></li>
                                    <li><a href="{{route('pages-timeline')}}" data-key="t-timeline">Timeline</a></li>
                                    <li><a href="{{route('pages-faqs')}}" data-key="t-faqs">FAQs</a></li>
                                    <li><a href="{{route('pages-pricing')}}" data-key="t-pricing">Pricing</a></li>
                                    <li><a href="{{route('pages-404')}}" data-key="t-error-404">Error 404</a></li>
                                    <li><a href="{{route('pages-500')}}" data-key="t-error-500">Error 500</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('form-elements')}}" data-key="t-form-elements">Basic Elements</a></li>
                                    <li><a href="{{route('form-validation')}}" data-key="t-form-validation">Validation</a></li>
                                    <li><a href="{{route('form-advanced')}}" data-key="t-form-advanced">Advanced Plugins</a></li>
                                    <li><a href="{{route('form-editors')}}" data-key="t-form-editors">Editors</a></li>
                                    <li><a href="{{route('form-uploads')}}" data-key="t-form-upload">File Upload</a></li>
                                    <li><a href="{{route('form-wizard')}}" data-key="t-form-wizard">Wizard</a></li>
                                    <li><a href="{{route('form-mask')}}" data-key="t-form-mask">Mask</a></li>
                                </ul>
                            </li>
        ...
        <script src="{{ URL::asset('assets/libs/jquery-datetimepicker/2.5.4/jquery.datetimepicker.full.min.js') }}"></script>
        <script src="{{ URL::asset('assets/libs/moment.js/2.18.1/moment.min.js') }}"></script>
        <script src="{{ URL::asset('assets/libs/jqueryui/1.11.4/jquery-ui.min.js') }}"></script>
      
        <script src="{{ URL::asset('assets/js/Common.js') }}"></script>
        <script src="{{ URL::asset('assets/js/app.js') }}"></script>
        <script src="http://143.110.180.160/DGMudra/public/assets/plugins/select2/js/select2.min.js"></script>
