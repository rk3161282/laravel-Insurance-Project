                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <form id="pristine-valid-example" novalidate="true" method="post">
                                <input type="hidden">
                                <div class="row">
                        ...
                        <div>
                            ...
                            <form id="pristine-valid-common" novalidate="true" method="post">
                                <input type="hidden">
                                <div class="row">
                                    <div class="col-xl-4 col-md-6">
                                        <div class="form-group mb-3">
                        ...
                        <div>
                            ...
                            <form id="pristine-valid-specificfield" novalidate="true" method="post">
                                <div class="form-group mb-3">
